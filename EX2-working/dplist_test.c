...
* \author Liam Simons
	...
	In the file:		Test_Cases.md
	are all the different possible cases to be tested.
	For each function there is a different group of test cases.
	Each case handling a different possible input argument.
*/
